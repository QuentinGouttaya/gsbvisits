...
<a href="/">Home</a>
  ...
  <h1>Create Report</h1>
  <form action="/reports/create" method="post" id="reportForm">
    ...
    <select name="doctor_id" id="doctor_id" required>
      ...
      <?php foreach ($doctors as $doctor) : ?>
        <option value="<?php echo $doctor->getId(); ?>"><?php echo $doctor->getFullName(); ?></option>
      <?php endforeach; ?>
    </select>
    ...
    <fieldset>
      ...
      <template id="medicamentTemplate">
        <div class="medicament-container">
          ...
          <input type="number" name="quantity[]" placeholder="Quantité" min="1">
